...
#[link(name = "papi")]
extern  {
    pub fn PAPI_is_initialized() -> libc::c_int;
    pub fn PAPI_num_counters() -> libc::c_int;
    pub fn PAPI_start_counters(events: *const libc::c_int, len: libc::c_int) -> libc::c_int;
    pub fn PAPI_stop_counters(events: *const libc::c_longlong, len: libc::c_int) -> libc::c_int;
    pub fn PAPI_read_counters(values: *mut libc::c_longlong, len: libc::c_int) -> libc::c_int;
    pub fn PAPI_accum_counters(values: *mut libc::c_longlong, len: libc::c_int) -> libc::c_int;
}
